...
app = FastAPI(
    ...
    description="API for generating legal petitions using Claude 3.5 Sonnet",
    version="1.0.0"
)
...
class LegalPetitionGenerator:
    ...
    def generate_facts(self, prompt: str, cmei_name: str) -> str:
        ...
        try:
            ...
            Importante:
            - Traga uma resposta completa que possa deixar os fatos mais explicativos possivel de forma juridica
    ...
    async def gerar_peticao(self, request: PetitionRequest) -> tuple[str, str, dict]:
        try:
            ...
            petition = PETITION_TEMPLATE.format(
                ...
                facts=facts,
                defender_name="Jaziella Ferreira Gomes Bueno Moreira"  # Nome fixo da defensora
            )
